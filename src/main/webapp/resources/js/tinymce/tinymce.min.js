...
!function(e, t) {
    ...
    r(l, [], function() {
        ...
        E = o.isXML = function(e) {
            ...
            if ((e.ownerDocument || e) !== B && A(e), t = t.replace(Ct, "='$1']"), z.matchesSelector && H && (!M || !M.test(t)) && !D.test(t))
                try {
                    var n = P.call(e, t);
        ...
        return function(e, t) {
            ...
            return{toHex: function(e) {
                    ...
                    function s(e, t) {
                        var n, r, i, o;
                        "none" === h["border-image"] && delete h["border-image"], n = h[e + "-top" + t], n && (r = h[e + "-right" + t], n == r && (i = h[e + "-bottom" + t], r == i && (o = h[e + "-left" + t], i == o && (h[e + t] = o, delete h[e + "-top" + t], delete h[e + "-right" + t], delete h[e + "-bottom" + t], delete h[e + "-left" + t]))))
                    }
                    function l(e) {
                        var t = h[e], n;
                        if (t && !(t.indexOf(" ") < 0)) {
                    ...
                    if (t) {
                        for (t = t.replace(/[\u0000-\u001F]/g, ""), t = t.replace(/\\[\"\';:\uFEFF]/g, d).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(e) {
                            ...
                            if (g = m[1].replace(a, "").toLowerCase(), v = m[2].replace(a, ""), g && v.length > 0) {
                                if (!e.allow_script_urls && ("behavior" == g || /expression\s*\(/.test(v)))
                                    continue;
                                "font-weight" === g && "700" === v ? v = "bold" : ("color" === g || "background-color" === g) && (v = v.toLowerCase()), v = v.replace(r, n), v = v.replace(i, p), h[g] = y ? f(v, !0) : v
                            }
        ...
        function t(n) {
            ...
            function _(e, t, r) {
                var i, o;
                for (e?(D[V] = t, D[W] = r):(D[U] = t, D[q] = r), i = D[U]; i.parentNode; )
                    i = i.parentNode;
            ...
            function E(e) {
                ...
                if (e != I && (t = r()), D[W] == D[q])
                    return t;
                if (3 == D[V].nodeType) {
                    if (n = D[V].nodeValue, i = n.substring(D[W], D[q]), e != O && (o = D[V], c = D[W], u = D[q] - D[W], 0 === c && u >= o.nodeValue.length - 1 ? o.parentNode.removeChild(o) : o.deleteData(c, u), D.collapse(F)), e == I)
                        return;
                    return i.length > 0 && t.appendChild(M.createTextNode(i)), t
                }
                for (o = C(D[V], D[W]), a = D[q] - D[W]; o && a > 0; )
                    s = o.nextSibling, l = L(o, e), t && t.appendChild(l), --a, o = s;
                return e != O && D.collapse(F), t
            }
            function k(e, t) {
                var n, i, o, a, s, l;
                if (t != I && (n = r()), i = R(e, t), n && n.appendChild(i), o = j(e), a = o - D[W], 0 >= a)
            ...
            function B(e, t, r, i) {
                ...
                if (t)
                    return L(e, i);
                if (3 == e.nodeType) {
                    if (o = e.nodeValue, r ? (l = D[W], a = o.substring(l), s = o.substring(0, l)) : (l = D[q], a = o.substring(0, l), s = o.substring(l)), i != O && (e.nodeValue = s), i == I)
                        return;
        ...
        return function(i, o) {
            ...
            i = i || {}, a.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var s = this, l, c = 0, u, d, f = [], p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, H, D, M, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href");
            ...
            function r(r) {
                ...
                function p(t) {
                    ...
                    if (s = i.createRng(), t.hasChildNodes()) {
                        ...
                        "BR" == t.nodeName ? t.nextSibling && i.isBlock(t.nextSibling) ? ((!A || 9 > A) && (u = i.create("br"), t.parentNode.insertBefore(u, t)), s.setStartBefore(t), s.setEndBefore(t)) : (s.setStartAfter(t), s.setEndAfter(t)) : (s.setStart(t, 0), s.setEnd(t, 0));
                    o.setRng(s), i.remove(u), o.scrollIntoView(t)
                }
                function h(e) {
                ...
                function m(e) {
                    var t = S, r, o, s;
                    if (e || "TABLE" == M ? (r = i.create(e || O), h(r)) : r = R.cloneNode(!1), s = r, a.keep_styles !== !1)
                        do
                ...
                function v(e, n) {
                    ...
                    if (o = i.getParent(e, i.isBlock), d = t.getBody().nodeName.toLowerCase(), !o || !u(o)) {
                        if (o = o || k, !o.hasChildNodes())
                            return r = i.create(f), h(r), o.appendChild(r), N.setStart(r, 0), N.setEnd(r, 0), r;
                        for (s = e; s.parentNode != o; )
                            s = s.parentNode;
                        for (; s && !i.isBlock(s); )
                            a = s, s = s.previousSibling;
                        if (a && l.isValidChild(d, f.toLowerCase())) {
                            for (r = i.create(f), h(r), a.parentNode.insertBefore(r, a), s = a; s && !i.isBlock(s); )
                ...
                function y() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (O = "LI"), L = O ? m(O) : i.create("BR"), e(!0) && e() ? "LI" == n ? i.insertAfter(L, t()) : i.replace(L, D) : e(!0) ? "LI" == n ? (i.insertAfter(L, t()), L.appendChild(i.doc.createTextNode(" ")), L.appendChild(D)) : D.parentNode.insertBefore(L, D) : e() ? (i.insertAfter(L, t()), d(L)) : (D = t(), E = N.cloneRange(), E.setStartAfter(R), E.setEndAfter(D), H = E.extractContents(), "LI" == O && "LI" == H.firstChild.nodeName ? (L = H.firstChild, i.insertAfter(H, D)) : (i.insertAfter(H, D), i.insertAfter(L, D))), i.remove(R), p(L), s.add()
                }
                function b() {
                ...
                var N = o.getRng(!0), E, k, S, T, R, A, B, L, H, D, M, P, O, I;
                if (!N.collapsed)
                ...
                if (!r.isDefaultPrevented() && (S = N.startContainer, T = N.startOffset, O = (a.force_p_newlines ? "p" : "") || a.forced_root_block, O = O ? O.toUpperCase() : "", A = i.doc.documentMode, B = r.shiftKey, 1 == S.nodeType && S.hasChildNodes() && (I = T > S.childNodes.length - 1, S = S.childNodes[Math.min(T, S.childNodes.length - 1)] || S, T = I && 3 == S.nodeType ? S.nodeValue.length : 0), k = w(S))) {
                    ...
                    if ("PRE" == M && a.br_in_pre !== !1) {
                        if (!B)
                            return C(), void 0
                    } else if (!O && !B && "LI" != M || O && B)
                        return C(), void 0;
                    O && R === t.getBody() || (O = O || "P", g() ? (L = /^(H[1-6]|PRE|FIGURE)$/.test(M) && "HGROUP" != P ? m(O) : m(), a.end_container_on_empty_block && u(D) && i.isEmpty(R) ? L = i.split(D, R) : i.insertAfter(L, R), p(L)) : g(!0) ? (L = R.parentNode.insertBefore(m(), R), d(L), p(R)) : (E = N.cloneRange(), E.setEndAfter(R), H = E.extractContents(), x(H), L = H.firstChild, i.insertAfter(H, R), f(L), _(R), p(L)), i.setAttrib(L, "id", ""), t.fire("NewBlock", {newBlock: L}), s.add())
                }
            }
        ...
        return function(n) {
            ...
            o(this, {execCommand: r, queryCommandState: p, queryCommandValue: h, addCommands: m}), m({"mceResetDesignMode,mceBeginUndoLevel": function() {
                    ...
                    if (d = a.parse(i, b), m = d.lastChild, "mce_marker" == m.attr("id"))
                        for (p = m, m = m.prev; m; m = m.walk(!0))
                            if (3 == m.type || !x.isBlock(m.name)) {
                                m.parent.insert(p, m, "br" === m.name);
                                break
                            }
                    if (b.invalid) {
                        for (w.setContent(v), l = w.getNode(), c = n.getBody(), 9 == l.nodeType?l = m = c:m = l; m !== c; )
                            l = m, m = m.parentNode;
                        ...
                        i = s.serialize(d), m = l.firstChild, g = l.lastChild, !m || m === g && "BR" === m.nodeName ? x.setHTML(l, i) : w.setContent(i);
                    p = x.get("mce_marker"), w.scrollIntoView(p), h = x.createRng(), m = p.previousSibling, m && 3 == m.nodeType ? (h.setStart(m, m.nodeValue.length), u || (g = p.nextSibling, g && 3 == g.nodeType && (m.appendData(g.data), g.parentNode.removeChild(g)))) : (h.setStartBefore(p), h.setEndBefore(p)), x.remove(p), w.setRng(h), n.fire("SetContent", f), n.addVisual()
        ...
        return function(a) {
            ...
            function u() {
                function t(e) {
                    ...
                    if (n.collapsed || (e = !0), l = n[(e ? "start" : "end") + "Container"], c = n[(e ? "start" : "end") + "Offset"], 3 == l.nodeType && (r = z.getParent(n.startContainer, z.isBlock), e && (r = z.getNext(r, z.isBlock)), !r || !t() && n.collapsed || (i = z.create("em", {id: "__mceDel"}), O(o.grep(r.childNodes), function(e) {
                        ...
                        for (s = W.getBookmark(); u = z.get("__mceDel"); )
                            z.remove(u, !0);
                        W.moveToBookmark(s)
                    }
                }
                ...
                a.on("keydown", function(t) {
                    ...
                    if (n = t.keyCode == F, !c(t) && (n || t.keyCode == I) && !e.modifierPressed(t) && (r = W.getRng(), i = r.startContainer, o = r.startOffset, u = r.collapsed, 3 == i.nodeType && i.nodeValue.length > 0 && (0 === o && !u || u && o === (n ? 0 : 1)))) {
                        if (l = i.previousSibling, l && "IMG" == l.nodeName)
                            return;
                        d = a.schema.getNonEmptyElements(), t.preventDefault(), s = z.create("br", {id: "__tmp"}), i.parentNode.insertBefore(s, i), a.getDoc().execCommand(n ? "ForwardDelete" : "Delete", !1, null), i = W.getRng().startContainer, l = i.previousSibling, l && 1 == l.nodeType && !z.isBlock(l) && z.isEmpty(l) && !d[l.nodeName.toLowerCase()] && z.remove(l), z.remove("__tmp")
                    }
                })
            }
            function N() {
            ...
            C(), N(), d(), H(), K && (_(), u(), p(), g(), S(), i.iOS ? (y(), M()) : f()), j && i.ie < 11 && (h(), b(), x(), w(), R(), A(), B(), L()), i.ie >= 11 && P(), $ && (h(), m(), v(), E(), k(), T(), D())
        }
    }), r(nt, [p], function(e) {
        function t() {
            return!1
        ...
        return N.prototype = {render: function() {
                ...
                if (!e.removed) {
                    ...
                    var t = e.getDoc();
                    P && t && t.execCommand("SelectAll"), e.save(), E.setStyle(e.id, "display", e.orgDisplay), e.settings.content_editable || (D.unbind(e.getWin()), D.unbind(e.getDoc()));
        ...
        function n(r) {
            ...
            function s(s) {
                ...
                c.on("init", function() {
                    ...
                    c.selection.lastFocusBookmark && (c.selection.setRng(a(c, c.selection.lastFocusBookmark)), c.selection.lastFocusBookmark = null), e != c && (e && e.fire("blur", {focusedEditor: c}), r.activeEditor = c, c.fire("focus", {blurredEditor: e}), c.focus(!1), r.focusedEditor = c), u = null
        ...
        var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, h, m = {majorVersion: "4", minorVersion: "0.10", releaseDate: "2013-10-28", editors: [], i18n: s, activeEditor: null, setup: function() {
                var e = this, t, n, i = "", o;
        ...
        return e.extend({recalc: function(e) {
                ...
                if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[z], x[L] = i[R] - d, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    ...
                    for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l?w = d + o[T]:"center" == l?(w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])):"justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[H] = o[I], t = 0, n = r.length; n > t; t++)
                        p = r[t], h = p.layoutRect(), y = h.maxFlexSize || h[E], "center" === s ? x[H] = Math.round(i[D] / 2 - h[M] / 2) : "stretch" === s ? (x[M] = V(h[P] || 0, i[D] - o[I] - o[F]), x[H] = o[I]) : "end" === s && (x[H] = i[D] - h[M] - o.top), h.flex > 0 && (y += Math.ceil(h.flex * C)), x[N] = y, x[k] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
