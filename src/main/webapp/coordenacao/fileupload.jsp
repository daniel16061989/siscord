			...
			<div id="content-box">
				<div id="content">
					<div class="bloco-left">
						...
						<s:form action="fileUploadAction" namespace="/" method="POST" enctype="multipart/form-data">
							<s:file name="fileUpload" label="Selecione o Arquivo dos alunos para upload" size="40" />
							<s:submit value="Salvar Alunos" name="submit" />
						</s:form>
