...
@Namespace(value = "/aterarSenhaProfessor")
public class AterarSenhaProfessorAction extends GenericAction {

	private static final long serialVersionUID = 1L;

	@Action(value = "index", results = { @Result(name = "success", location = "/professor/trocarSenha.jsp") })
	public String index() {
		return SUCCESS;
	}
