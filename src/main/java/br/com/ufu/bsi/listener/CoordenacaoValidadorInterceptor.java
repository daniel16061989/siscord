...
public class CoordenacaoValidadorInterceptor extends AbstractInterceptor {
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		if (!usuarioLogado.getUsuario().getTipoUsuario().equals(Usuario.TIPO_USUARIO_COORDENACAO))
			return "inicio";
